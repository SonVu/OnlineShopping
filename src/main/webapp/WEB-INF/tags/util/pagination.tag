    ...
    <ul class="pager text-right">
        <c:choose>
            <c:when test="${pageNumber ne 0}">
                ...
                <spring:message var="first_label" text="First"
                                htmlEscape="false" />
        ...
        <c:choose>
            <c:when test="${pageNumber gt 0}">
                ...
                <spring:message var="previous_label"
        ...
        <c:out value=" " />
        <spring:message text="Page {0} of {1}"
        ...
        <c:choose>
            <c:when test="${pageNumber lt (maxPages-1)}">
                ...
                <spring:url value="/resources/images/resultset_next.png"
                            var="next_image_url" />
                <spring:message var="next_label" text="Next"
                                htmlEscape="false" />
        ...
        <c:choose>
            <c:when test="${pageNumber ne (maxPages-1)}">
                ...
                <spring:message var="last_label" text="Last"
                                htmlEscape="false" />
