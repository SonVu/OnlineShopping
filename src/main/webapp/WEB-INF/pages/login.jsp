...
<html lang="en">
  <head>
    ...
    <link href="../../resource/assets/style.css" rel="stylesheet"/>
...
<div class="pull-right"> <br/>
	<a href="sc"> <span class="btn btn-mini btn-warning"> <i class="icon-shopping-cart icon-white"></i> [ 3 ] </span> </a>
...
<div id="sidebar" class="span3">
	<ul class="nav nav-list bs-docs-sidenav" style="display: block;">											
		<li class="subMenu"><a> ELECTRONICS [230]</a>
			<ul>
			<li><a class="active" href="category.jsp">Cameras (100)</a></li>
			<li><a href="category.jsp">Computers, Tablets & laptop (30)</a></li>
			<li><a href="category.jsp">Mobile Phone (80)</a></li>
			<li><a href="category.jsp">Sound & Vision (15)</a></li>
			</ul>
		</li>
		<li class="subMenu"><a> CLOTHES [840] </a>
		<ul>
			<li><a href="category.jsp">Women's Clothing (45)</a></li>
			<li><a href="category.jsp">Women's Shoes (8)</a></li>
			<li><a href="category.jsp">Women's Hand Bags (5)</a></li>
			<li><a href="category.jsp">Men's Clothings  (45)</a></li>
			<li><a href="category.jsp">Men's Shoes (6)</a></li>
			<li><a href="category.jsp">Kids Clothing (5)</a></li>
			<li><a href="category.jsp">Kids Shoes (3)</a></li>
		</ul>
		</li>
		<li class="subMenu"><a>FOOD AND BEVERAGES [1000]</a>
			<ul>
			<li><a href="category.jsp">Angoves  (35)</a></li>
			<li><a href="category.jsp">Bouchard Aine & Fils (8)</a></li>
			<li><a href="category.jsp">French Rabbit (5)</a></li>
			<li><a href="category.jsp">Louis Bernard  (45)</a></li>
			<li><a href="category.jsp">BIB Wine (Bag in Box) (8)</a></li>
			<li><a href="category.jsp">Other Liquors & Wine (5)</a></li>
			<li><a href="category.jsp">Garden (3)</a></li>
			<li><a href="category.jsp">Khao Shong (11)</a></li>
		</ul>
		</li>
		<li><a href="category.jsp">HEALTH & BEAUTY [18]</a></li>
		<li><a href="category.jsp">SPORTS & LEISURE [58]</a></li>
		<li><a href="category.jsp">BOOKS & ENTERTAINMENTS [14]</a></li>
		<li style="border:0"> &nbsp;</li>						
		<li> <a href="sc"><strong>3 Items in your cart  <span class="badge badge-warning pull-right" style="line-height:18px;">$155.00</span></strong></a></li>
		<li style="border:0"> &nbsp;</li>	
		<li>
		  <div class="thumbnail">
